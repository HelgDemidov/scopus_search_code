...
export const BLACK_HOLE_DIAMETER_RATIO_MOBILE = 0.0385; // 0.055 × 0.7 — уменьшено на 30% чтобы не доминировать на экране
...
export const BLACK_HOLE_POSITION_MOBILE_Y_PX = 460; // поднято: край вортекса должен заканчиваться чуть ниже нижнего края рамки ошибки
...
export const VORTEX_RADIUS_RATIO_MOBILE = 0.14; // 0.20 × 0.7 — уменьшено на 30% для мобильных
...
export const SECONDARY_NEBULA_RADIUS_RATIO_MOBILE = 0.154; // 0.22 × 0.7 — уменьшено на 30% для мобильных
