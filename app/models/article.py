...
class Article(Base):
    ...
    journal: Mapped[str] = mapped_column(String(500), nullable=True)                   # prism:publicationName — журнал  # noqa: E501
    ...
    doi: Mapped[str] = mapped_column(String(255), nullable=True)                       # prism:doi — unique=True перенесен в __table_args__  # noqa: E501

    # Расширенные наукометрические поля (доступны в Scopus free-tier)
    cited_by_count: Mapped[int] = mapped_column(Integer, nullable=True)                # citedby-count — число цитирований  # noqa: E501
    document_type: Mapped[str] = mapped_column(String(100), nullable=True)             # subtypeDescription — тип документа  # noqa: E501
    open_access: Mapped[bool] = mapped_column(Boolean, nullable=True)                  # openaccess — флаг открытого доступа  # noqa: E501
    affiliation_country: Mapped[str] = mapped_column(String(100), nullable=True)       # affiliation[0].affiliation-country  # noqa: E501
